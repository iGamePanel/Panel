        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom nav-tabs-floating">
                <ul class="nav nav-tabs">
                    ...
                    <li @if($activeTab === 'auth')class="active"@endif><a href="{{ route('admin.settings.auth') }}">Authentification</a></li>
                    <li @if($activeTab === 'advanced')class="active"@endif><a href="{{ route('admin.settings.advanced') }}">Autres</a></li>
                </ul>
            </div>
        </div>
    </div>
