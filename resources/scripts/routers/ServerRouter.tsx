        ...
        status === 'installing' || status === 'install_failed' ?
            ...
            status === 'suspended' ?
                <ScreenBlock
                    ...
                    message={'Ce service est suspendu et n\'est pas accessible.'}
                />
                :
                <ScreenBlock
                    title={isTransferring ? 'Transfert en cours' : 'Restauration d\'une sauvegarde'}
                    ...
                    <CSSTransition timeout={150} classNames={'fade'} appear in>
                        <SubNavigation>
                            <div>
                                ...
                                <Can action={'file.*'}>
                                    <NavLink to={`${match.url}/files`}>Gestion des fichiers</NavLink>
                                </Can>
                                {(databaseLimit > 0 || databaseLimit == undefined) &&
                                    <Can action={'database.*'}>
                                        <NavLink to={`${match.url}/databases`}>Base de données</NavLink>
                                    </Can>
                                }
                                <Can action={'schedule.*'}>
                                    <NavLink to={`${match.url}/schedules`}>Gestionnaire des tâches</NavLink>
                                </Can>
                                <Can action={'user.*'}>
                                    <NavLink to={`${match.url}/users`}>Sous-utilisateurs</NavLink>
                                </Can>
                                {(backupLimit > 0 || backupLimit == undefined) &&
                                    <Can action={'backup.*'}>
