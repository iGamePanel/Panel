                ...
                {(!stats || isSuspended) ?
                    isSuspended ?
                        <div css={tw`flex-1 text-center`}>
                            <span css={tw`bg-red-500 rounded px-2 py-1 text-red-100 text-xs`}>
                                {server.status === 'suspended' ? 'Suspendu' : 'Indisponible'}
                            </span>
                        </div>
                        :
                            ...
                            <div css={tw`flex-1 text-center`}>
                                <span css={tw`bg-neutral-500 rounded px-2 py-1 text-neutral-100 text-xs`}>
                                    {server.isTransferring ?
                                        'Transfert...'
                                        :
                                        server.status === 'installing' ? 'Installation...' : (
                    ...
                    <React.Fragment>
                        ...
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            ...
                            <p css={tw`text-xs text-neutral-600 text-center mt-1`}>sur {memoryLimit}</p>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                            ...
                            <p css={tw`text-xs text-neutral-600 text-center mt-1`}>sur {diskLimit}</p>
                        </div>
                    </React.Fragment>
                }
            </div>
