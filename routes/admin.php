...
use Pterodactyl\Http\Controllers\Admin\Offre\IndexOffreController;
...
/*
|--------------------------------------------------------------------------
| Offre Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/offre
|
*/
Route::group(['prefix' => 'offre'], function () {
    Route::get('/', 'IndexOffreController@index')->name('admin.offre');
});
...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/authentification', 'Settings\AuthController@index')->name('admin.settings.auth');
    ...
    Route::patch('/authentification', 'Settings\AuthController@update');
